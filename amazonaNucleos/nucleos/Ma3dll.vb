...
Namespace XRite
    ...
    Public Class MA3
        ...
        End Function
        Public Overloads Function isConnected() As Boolean
            Return MA3dll.IsConnected()
        End Function
        Public Overloads Function Measure() As Boolean
            Return MA3dll.Measure()
        End Function
        Public Overloads Function GetSpectralData(ByVal dataSet As Integer, ByVal wl As Integer) As Single
            Return MA3dll.GetSpectralData(dataSet, wl)
        End Function
        Public Overloads Function IsDataReady() As Boolean
            Return MA3dll.IsDataReady()
        End Function

        Public Overloads Function GetLastErrorString() As IntPtr
            Return MA3dll.GetLastErrorString()
        End Function
